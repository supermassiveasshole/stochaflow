...
def test_public_extension_contracts_reexport_runtime_types() -> None:
    expected = {
        ...
        "DataRankContext": data.DataRankContext,
        ...
        "ExactCoverageReceipt": data.ExactCoverageReceipt,
        "ExactCoverageSpan": data.ExactCoverageSpan,
        "ExactValidationBatch": data.ExactValidationBatch,
        "ExactValidationEpochPlan": data.ExactValidationEpochPlan,
        "ExactValidationEpochReader": data.ExactValidationEpochReader,
        "ExactValidationExecution": data.ExactValidationExecution,
        ...
        "RankedBatchFacts": data.RankedBatchFacts,
        "RankedDataExecution": data.RankedDataExecution,
        "RankedEpochCompletion": data.RankedEpochCompletion,
        "RankedEpochDataIdentity": data.RankedEpochDataIdentity,
        "RankedTrainEpochPlan": data.RankedTrainEpochPlan,
        "RankedTrainEpochReader": data.RankedTrainEpochReader,
        "RankedTrainExecution": data.RankedTrainExecution,
        "RankedTrainWindow": data.RankedTrainWindow,
        ...
        "TrainingExecutionBindingBuilder": (
            training.TrainingExecutionBindingBuilder
        ),
